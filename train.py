...
def process_data(data_dir):
    ...
    train_datasets = datasets.ImageFolder(train_dir, transform=modified_transf)
    valid_datasets = datasets.ImageFolder(valid_dir, transform=modified_transf)
    test_datasets = datasets.ImageFolder(test_dir, transform=modified_transf)
